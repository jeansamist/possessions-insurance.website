    ...
    <footer id="contact" className="bg-ink text-white pt-16 pb-6">
      <div className="max-w-6xl mx-auto px-5 sm:px-8">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-10 lg:gap-12">
          ...
          {/* Contact */}
          <div>
            <div className="text-[10px] font-semibold tracking-[0.13em] uppercase text-white/40 mb-3">
              Contact
            </div>
            <ul className="space-y-2.5 text-sm text-white/80">
              <li className="flex gap-2.5 items-start">
                <MapPin
                  size={14}
                  className="text-green-soft mt-0.5 flex-shrink-0"
                />
                {SITE.address}, {SITE.city}
              </li>
              <li className="flex gap-2.5 items-center">
                <Phone size={14} className="text-green-soft flex-shrink-0" />
                <a
                  href={SITE.phoneHref}
              ...
              <li className="flex gap-2.5 items-center">
                <Mail size={14} className="text-green-soft flex-shrink-0" />
                <a
            ...
            <div className="mt-5">
              <div className="text-[10px] font-semibold tracking-[0.13em] uppercase text-white/40 mb-2">
                Hours
              </div>
              <ul className="text-sm text-white/75 space-y-1">
                <li className="flex items-center gap-2">
                  <Clock size={13} className="text-green-soft" />
                  Mon–Fri · 9am–6pm
                </li>
        ...
        <div className="border-t border-white/10 mt-12 pt-6">
          ...
          <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4">
            <p className="text-white/45 text-xs">
              © 2026 {SITE.name} · Licensed Independent Insurance Agency ·{" "}
              {SITE.city.split(",")[0]}, FL
            </p>
          ...
          <p className="mt-4 text-white/25 text-[11px] leading-relaxed max-w-4xl">
            Possessions Insurance is a licensed independent insurance agency in
            the State of Florida. License #{SITE.license}. We are not affiliated
            with or endorsed by any insurance carrier. Coverage availability,
            eligibility, and premiums vary by carrier and individual
            circumstances. Information on this site is for general informational
            purposes only and does not constitute insurance advice.
          </p>
        </div>
      </div>
    </footer>
