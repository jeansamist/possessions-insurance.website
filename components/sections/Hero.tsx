...
export default function Hero({ onOpenQuiz }: HeroProps) {
  ...
  return (
    <section
      ...
      style={{
        background: "linear-gradient(180deg,#33A64D 0%,#2b8d41 100%)",
        paddingTop: 88,
        paddingBottom: 96,
      }}
    >
      ...
      <div
        ...
        style={{
          background:
            "radial-gradient(circle,rgba(255,255,255,.16),transparent 60%)",
        }}
      />
      <div
        aria-hidden="true"
      ...
      <div className="max-w-6xl mx-auto px-5 sm:px-8 relative">
        ...
        <p className="text-white/90 text-lg leading-relaxed max-w-2xl mx-auto mt-6 animate-[fadeDown_0.65s_cubic-bezier(.22,1,.36,1)_.35s_both]">
          We help South Florida families and businesses find better coverage,
          better rates, and real support — without the call centers, confusing
          policies, or pressure.
        </p>
        ...
        <div className="animate-[fadeDown_0.65s_cubic-bezier(.22,1,.36,1)_.5s_both]">
          ...
          >
            ...
            <span
              className="hidden sm:block h-6 w-px bg-line flex-shrink-0 mx-2"
              aria-hidden
            />
            <label className="flex items-center gap-2.5 flex-1 py-2 sm:py-0 w-full">
              ...
              >
                ...
                <option>Home</option>
                <option>Auto</option>
                <option>Home + Auto bundle</option>
                <option>Health</option>
                <option>Business</option>
                <option>Not sure — help me</option>
              </select>
            </label>
            <button
              onClick={onOpenQuiz}
              className="btn-cta w-full sm:w-auto mt-2 sm:mt-0 flex-shrink-0"
              aria-label="Start coverage check"
            >
          ...
          <div className="mt-4">
            <button
              onClick={onOpenQuiz}
              className="btn-ghost btn-cta-sm inline-flex items-center gap-2"
              aria-label="Talk to a local agent"
            >
        ...
        {/* Trust pills */}
        <ul
          className="flex flex-wrap gap-4 justify-center mt-7 list-none
